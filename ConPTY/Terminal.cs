using ClaudeSessionManager.Wpf.ConPTY.Processes;
using Microsoft.Win32.SafeHandles;
using System;
using System.IO;
using System.Threading;
using static ClaudeSessionManager.Wpf.ConPTY.Native.ConsoleApi;
...
namespace ClaudeSessionManager.Wpf.ConPTY
{
    ...
    public sealed class Terminal
    {
        ...
        /// <summary>
        /// Resizes the pseudoconsole to the given dimensions.
        /// </summary>
        public void Resize(int cols, int rows)
        {
            if (cols <= 0 || rows <= 0) return;
            short c = cols > short.MaxValue ? short.MaxValue : (short)cols;
            short r = rows > short.MaxValue ? short.MaxValue : (short)rows;
            _pseudoConsole?.Resize(c, r);
        }
